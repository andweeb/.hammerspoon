...
VLC.openRecent = Application.createMenuItemChooserEvent({ "File", "Open Recent" })
-- View actions
...
VLC.playlistTableColumns = Application.createMenuItemChooserEvent({ "View", "Playlist Table Columns" })
-- Playback actions
...
VLC.renderer = Application.createMenuItemChooserEvent({ "Playback", "Renderer" })
-- Audio actions
...
VLC.audioDevice = Application.createMenuItemChooserEvent({ "Audio", "Audio Device" })
VLC.audioTrack = Application.createMenuItemChooserEvent({ "Audio", "Audio Track" })
VLC.stereoAudioMode = Application.createMenuItemChooserEvent({ "Audio", "Stereo audio mode" })
VLC.visualizations = Application.createMenuItemChooserEvent({ "Audio", "Visualizations" })
-- Video actions
...
VLC.aspectRatio = Application.createMenuItemChooserEvent({ "Video", "Aspect ratio" })
VLC.crop = Application.createMenuItemChooserEvent({ "Video", "Crop" })
VLC.deinterlaceMode = Application.createMenuItemChooserEvent({ "Video", "Deinterlace mode" })
VLC.deinterlace = Application.createMenuItemChooserEvent({ "Video", "Deinterlace" })
VLC.fullscreenVideoDevice = Application.createMenuItemChooserEvent({ "Video", "Fullscreen Video Device" })
VLC.postProcessing = Application.createMenuItemChooserEvent({ "Video", "Post processing" })
VLC.videoTrack = Application.createMenuItemChooserEvent({ "Video", "Video Track" })
-- Subtitles actions
VLC.addSubtitleFile = Application.createMenuItemEvent({ "Subtitles", "Add Subtitle File..." })
VLC.backgroundColor = Application.createMenuItemChooserEvent({ "Subtitles", "Background Color" })
VLC.outlineThickness = Application.createMenuItemChooserEvent({ "Subtitles", "Outline Thickness" })
VLC.subtitleTrack = Application.createMenuItemChooserEvent({ "Subtitles", "Subtitle Track" })
VLC.teletext = Application.createMenuItemChooserEvent({ "Subtitles", "Teletext" })
VLC.textColor = Application.createMenuItemChooserEvent({ "Subtitles", "Text Color" })
VLC.textSize = Application.createMenuItemChooserEvent({ "Subtitles", "Text Size" })
-- Window actions
