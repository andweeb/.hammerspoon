...
MicrosoftExcel.printArea = Application.createMenuItemSelectionEvent({ "File", "Print Area" })
MicrosoftExcel.restrictPermissions = Application.createMenuItemSelectionEvent({ "File", "Restrict Permissions" })
MicrosoftExcel.share = Application.createMenuItemSelectionEvent({ "File", "Share" })
-- Edit actions
...
MicrosoftExcel.clear = Application.createMenuItemSelectionEvent({ "Edit", "Clear" })
MicrosoftExcel.fill = Application.createMenuItemSelectionEvent({ "Edit", "Fill" })
MicrosoftExcel.find = Application.createMenuItemSelectionEvent({ "Edit", "Find" })
MicrosoftExcel.sheet = Application.createMenuItemSelectionEvent({ "Edit", "Sheet" })
-- View actions
...
MicrosoftExcel["3DModels"] = Application.createMenuItemSelectionEvent({ "Insert", "3D Models" })
MicrosoftExcel.addIns = Application.createMenuItemSelectionEvent({ "Insert", "Add-ins" })
MicrosoftExcel.audio = Application.createMenuItemSelectionEvent({ "Insert", "Audio" })
MicrosoftExcel.chart = Application.createMenuItemSelectionEvent({ "Insert", "Chart" })
MicrosoftExcel.movie = Application.createMenuItemSelectionEvent({ "Insert", "Movie" })
MicrosoftExcel.picture = Application.createMenuItemSelectionEvent({ "Insert", "Picture" })
MicrosoftExcel.shape = Application.createMenuItemSelectionEvent({ "Insert", "Shape" })
MicrosoftExcel.sheet = Application.createMenuItemSelectionEvent({ "Insert", "Sheet" })
MicrosoftExcel.smartArt = Application.createMenuItemSelectionEvent({ "Insert", "SmartArt" })
-- Format actions
...
MicrosoftExcel.column = Application.createMenuItemSelectionEvent({ "Format", "Column" })
MicrosoftExcel.row = Application.createMenuItemSelectionEvent({ "Format", "Row" })
MicrosoftExcel.sheet = Application.createMenuItemSelectionEvent({ "Format", "Sheet" })
-- Tools actions
...
MicrosoftExcel.auditing = Application.createMenuItemSelectionEvent({ "Tools", "Auditing" })
MicrosoftExcel.macro = Application.createMenuItemSelectionEvent({ "Tools", "Macro" })
MicrosoftExcel.protection = Application.createMenuItemSelectionEvent({ "Tools", "Protection" })
MicrosoftExcel.trackChanges = Application.createMenuItemSelectionEvent({ "Tools", "Track Changes" })
-- Data actions
...
MicrosoftExcel.getExternalData = Application.createMenuItemSelectionEvent({ "Data", "Get External Data" })
MicrosoftExcel.groupAndOutline = Application.createMenuItemSelectionEvent({ "Data", "Group and Outline" })
MicrosoftExcel.tableTools = Application.createMenuItemSelectionEvent({ "Data", "Table Tools" })
-- Window actions
