...
TablePlus.import = Application.createMenuItemSelectionEvent({ "File", "Import" })
TablePlus.openRecent = Application.createMenuItemSelectionEvent({ "File", "Open Recent" })
-- Edit actions
...
TablePlus.find = Application.createMenuItemSelectionEvent({ "Edit", "Find" })
TablePlus.speech = Application.createMenuItemSelectionEvent({ "Edit", "Speech" })
TablePlus.transformations = Application.createMenuItemSelectionEvent({ "Edit", "Transformations" })
-- Connection actions
...
TablePlus.viewUsingEncoding = Application.createMenuItemSelectionEvent({ "Connection", "View Using Encoding" })
-- Plugins actions
