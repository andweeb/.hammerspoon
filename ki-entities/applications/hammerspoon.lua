...
Hammerspoon.find = Application.createMenuItemSelectionEvent({ "Edit", "Find" })
Hammerspoon.speech = Application.createMenuItemSelectionEvent({ "Edit", "Speech" })
Hammerspoon.spellingAndGrammar = Application.createMenuItemSelectionEvent({ "Edit", "Spelling and Grammar" })
Hammerspoon.substitutions = Application.createMenuItemSelectionEvent({ "Edit", "Substitutions" })
Hammerspoon.transformations = Application.createMenuItemSelectionEvent({ "Edit", "Transformations" })
-- Window actions
