...
MicrosoftWord.openRecent = Application.createMenuItemSelectionEvent({ "File", "Open Recent" })
MicrosoftWord.restrictPermissions = Application.createMenuItemSelectionEvent({ "File", "Restrict Permissions" })
MicrosoftWord.share = Application.createMenuItemSelectionEvent({ "File", "Share" })
-- Edit actions
...
MicrosoftWord.clear = Application.createMenuItemSelectionEvent({ "Edit", "Clear" })
MicrosoftWord.find = Application.createMenuItemSelectionEvent({ "Edit", "Find" })
-- View actions
...
MicrosoftWord.sidebar = Application.createMenuItemSelectionEvent({ "View", "Sidebar" })
-- Insert actions
...
MicrosoftWord["3DModels"] = Application.createMenuItemSelectionEvent({ "Insert", "3D Models" })
MicrosoftWord.addIns = Application.createMenuItemSelectionEvent({ "Insert", "Add-ins" })
MicrosoftWord.audio = Application.createMenuItemSelectionEvent({ "Insert", "Audio" })
MicrosoftWord.autoText = Application.createMenuItemSelectionEvent({ "Insert", "AutoText" })
MicrosoftWord["break"] = Application.createMenuItemSelectionEvent({ "Insert", "Break" })
MicrosoftWord.chart = Application.createMenuItemSelectionEvent({ "Insert", "Chart" })
MicrosoftWord.movie = Application.createMenuItemSelectionEvent({ "Insert", "Movie" })
MicrosoftWord.pictures = Application.createMenuItemSelectionEvent({ "Insert", "Pictures" })
MicrosoftWord.shape = Application.createMenuItemSelectionEvent({ "Insert", "Shape" })
MicrosoftWord.smartArt = Application.createMenuItemSelectionEvent({ "Insert", "SmartArt" })
MicrosoftWord.textBox = Application.createMenuItemSelectionEvent({ "Insert", "Text Box" })
-- Format actions
...
MicrosoftWord.asianLayout = Application.createMenuItemSelectionEvent({ "Format", "Asian Layout" })
-- Tools actions
...
MicrosoftWord.macro = Application.createMenuItemSelectionEvent({ "Tools", "Macro" })
MicrosoftWord.spellingAndGrammar = Application.createMenuItemSelectionEvent({ "Tools", "Spelling and Grammar" })
MicrosoftWord.trackChanges = Application.createMenuItemSelectionEvent({ "Tools", "Track Changes" })
MicrosoftWord.translate = Application.createMenuItemSelectionEvent({ "Tools", "Translate" })
-- Table actions
...
MicrosoftWord.autoFitAndDistribute = Application.createMenuItemSelectionEvent({ "Table", "AutoFit and Distribute" })
MicrosoftWord.convert = Application.createMenuItemSelectionEvent({ "Table", "Convert" })
MicrosoftWord.delete = Application.createMenuItemSelectionEvent({ "Table", "Delete" })
MicrosoftWord.insert = Application.createMenuItemSelectionEvent({ "Table", "Insert" })
MicrosoftWord.select = Application.createMenuItemSelectionEvent({ "Table", "Select" })
-- Window actions
