...
ScriptEditor.newFromTemplate = Application.createMenuItemSelectionEvent({ "File", "New from Template" })
ScriptEditor.openRecent = Application.createMenuItemSelectionEvent({ "File", "Open Recent" })
ScriptEditor.revertTo = Application.createMenuItemSelectionEvent({ "File", "Revert To" })
ScriptEditor.share = Application.createMenuItemSelectionEvent({ "File", "Share" })
-- Edit actions
...
ScriptEditor.find = Application.createMenuItemSelectionEvent({ "Edit", "Find" })
ScriptEditor.speech = Application.createMenuItemSelectionEvent({ "Edit", "Speech" })
ScriptEditor.spellingAndGrammar = Application.createMenuItemSelectionEvent({ "Edit", "Spelling and Grammar" })
ScriptEditor.substitutions = Application.createMenuItemSelectionEvent({ "Edit", "Substitutions" })
ScriptEditor.transformations = Application.createMenuItemSelectionEvent({ "Edit", "Transformations" })
-- View actions
...
ScriptEditor.baseline = Application.createMenuItemSelectionEvent({ "Font", "Baseline" })
ScriptEditor.characterShape = Application.createMenuItemSelectionEvent({ "Font", "Character Shape" })
ScriptEditor.kern = Application.createMenuItemSelectionEvent({ "Font", "Kern" })
ScriptEditor.ligatures = Application.createMenuItemSelectionEvent({ "Font", "Ligatures" })
-- Format actions
...
ScriptEditor.writingDirection = Application.createMenuItemSelectionEvent({ "Format", "Writing Direction" })
-- Window actions
