...
DataGrip.export = Application.createMenuItemSelectionEvent({ "File", "Export" })
DataGrip.fileProperties = Application.createMenuItemSelectionEvent({ "File", "File Properties" })
DataGrip.localHistory = Application.createMenuItemSelectionEvent({ "File", "Local History" })
DataGrip.manageIDESettings = Application.createMenuItemSelectionEvent({ "File", "Manage IDE Settings" })
DataGrip.newProjectsSettings = Application.createMenuItemSelectionEvent({ "File", "New Projects Settings" })
DataGrip.new = Application.createMenuItemSelectionEvent({ "File", "New" })
DataGrip.openRecent = Application.createMenuItemSelectionEvent({ "File", "Open Recent" })
-- Edit actions
...
DataGrip.convertIndents = Application.createMenuItemSelectionEvent({ "Edit", "Convert Indents" })
DataGrip.findUsages = Application.createMenuItemSelectionEvent({ "Edit", "Find Usages" })
DataGrip.find = Application.createMenuItemSelectionEvent({ "Edit", "Find" })
DataGrip.macros = Application.createMenuItemSelectionEvent({ "Edit", "Macros" })
-- View actions
...
DataGrip.appearance = Application.createMenuItemSelectionEvent({ "View", "Appearance" })
DataGrip.bidiTextBaseDirection = Application.createMenuItemSelectionEvent({ "View", "Bidi Text Base Direction" })
DataGrip.toolWindows = Application.createMenuItemSelectionEvent({ "View", "Tool Windows" })
-- Navigate actions
...
DataGrip.bookmarks = Application.createMenuItemSelectionEvent({ "Navigate", "Bookmarks" })
DataGrip.navigateInFile = Application.createMenuItemSelectionEvent({ "Navigate", "Navigate in File" })
-- Code actions
...
DataGrip.codeCompletion = Application.createMenuItemSelectionEvent({ "Code", "Code Completion" })
DataGrip.folding = Application.createMenuItemSelectionEvent({ "Code", "Folding" })
-- Refactor actions
...
DataGrip.debuggingActions = Application.createMenuItemSelectionEvent({ "Run", "Debugging Actions" })
DataGrip.runWithProfiler = Application.createMenuItemSelectionEvent({ "Run", "Run with Profiler" })
DataGrip.testHistory = Application.createMenuItemSelectionEvent({ "Run", "Test History" })
DataGrip.toggleBreakpoint = Application.createMenuItemSelectionEvent({ "Run", "Toggle Breakpoint" })
-- Tools actions
...
DataGrip.XMLActions = Application.createMenuItemSelectionEvent({ "Tools", "XML Actions" })
-- Window actions
...
DataGrip.activeToolWindow = Application.createMenuItemSelectionEvent({ "Window", "Active Tool Window" })
DataGrip.backgroundTasks = Application.createMenuItemSelectionEvent({ "Window", "Background Tasks" })
DataGrip.editorTabs = Application.createMenuItemSelectionEvent({ "Window", "Editor Tabs" })
DataGrip.notifications = Application.createMenuItemSelectionEvent({ "Window", "Notifications" })
-- Help actions
...
DataGrip.diagnosticTools = Application.createMenuItemSelectionEvent({ "Help", "Diagnostic Tools" })
