...
return Entity {
    name = "Clipboard Text",
    shortcuts = {
        { nil, "c", capitalizeWords, { "Clipboard Text", "Capitalize Words in Text" } },
        { nil, "d", decodeBase64, { "Clipboard Text", "Decode Base64" } },
        { nil, "e", encodeBase64, { "Clipboard Text", "Encode Base64" } },
        { nil, "j", formatJSON, { "Clipboard Text", "Format JSON" } },
        { nil, "k", kebabcase, { "Clipboard Text", "Convert Text to Kebabcase" } },
        { nil, "l", lowercase, { "Clipboard Text", "Convert Text to Lowercase" } },
        { nil, "n", normalcase, { "Clipboard Text", "Convert Text to Normal" } },
        { nil, "r", convertRtfToPlainText, { "Clipboard Text", "Convert RTF Text to Plain Text" } },
        { nil, "s", formatSQL, { "Clipboard Text", "Format SQL" } },
        { nil, "u", uppercase, { "Clipboard Text", "Convert Text to Uppercase" } },
        { nil, "x", formatXML, { "Clipboard Text", "Format XML" } },
        { nil, "space", openURL, { "Clipboard Text", "Open Copied URL" } },
        { { "shift" }, "c", camelcase, { "Clipboard Text", "Convert Text to Camelcase" } },
        { { "shift" }, "s", snakecase, { "Clipboard Text", "Convert Text to Snakecase" } },
    },
}
