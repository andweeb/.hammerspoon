...
function ClipboardTextEntity:init(Entity)
    ...
    local ClipboardText = self.Entity:new("Clipboard Text")
    ...
    function ClipboardText.selectEmoji()
        ClipboardText.showSelectionModal(self.emojis, function(choice)
            if choice then
                hs.pasteboard.setContents(choice.emoji)
                ClipboardText.notify("Copied "..choice.emoji)
            end
        end)
    end
    ...
    local actions = {
        ...
        selectEmoji = ClipboardText.selectEmoji,
    }
    local shortcuts = {
...
-- Emoji list: https://github.com/onmyway133/Smile/blob/master/Sources/Emoji.swift
local emojis = {
    ["grinning"] = "😀",
    ["smiley"] = "😃",
    ["smile"] = "😄",
...
-- Create emoji selection items
ClipboardTextEntity.emojis = {}
for name, emoji in pairs(emojis) do
    table.insert(ClipboardTextEntity.emojis, {
        text = emoji,
        subText = name,
        emoji = emoji,
    })
